...
const VideoPlayer = () => {
  ...
  return (
    <div className="video-container flex justify-center rounded-xl h-full w-1/2">
...
const Hero = ({
  ...
  return (
    ...
    >
      ...
      <ScrollAnimationWrapper>
        <div className="pt-[20px] px-4 sm:px-10 pb-[112px]">
          <ScrollAnimationWrapper>
            <motion.div
          ...
          <ScrollAnimationWrapper className="pt-12 px-2 sm:px-4">
            <motion.div
